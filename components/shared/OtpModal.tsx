                ...
                <>
                  ...
                  <div className="flex items-stretch bg-gray-100 rounded-xl overflow-hidden mb-4">
                    ...
                    <input
                      ...
                      className="flex-1 bg-transparent px-4 py-3.5 text-gray-900 text-base placeholder:text-gray-400 outline-none"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full py-3.5 rounded-xl text-white font-semibold text-sm tracking-wide transition-opacity hover:opacity-90 active:opacity-80"
              ...
              {step === "otp" && (
                <>
                  ...
                  <div className="flex justify-center gap-3 mb-6">
                    {digits.map((digit, i) => (
                      <input
                        ...
                        className="w-16 h-16 text-center text-xl font-bold text-gray-900
                                   border-2 rounded-xl outline-none transition-colors
                                   border-gray-200 focus:border-[#0B0C2A] bg-gray-50
                  ...
                  <button
                    ...
                    className="w-full py-3.5 rounded-xl text-white font-semibold text-sm tracking-wide transition-opacity hover:opacity-90 active:opacity-80 mb-4"
                  ...
                  <p className="text-center text-xs text-gray-500">
                    {countdown > 0 ? (
                      <>Didn&apos;t receive code?{" "}<span className="font-semibold text-gray-600">Resend in {countdown}s</span></>
                    ) : (
                      <>Didn&apos;t receive code?{" "}<button onClick={handleResend} className="font-semibold text-[#0B0C2A] hover:underline">Resend OTP</button></>
                    )}
                  </p>
                </>
              )}
